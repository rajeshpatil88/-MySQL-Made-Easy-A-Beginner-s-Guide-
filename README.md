...
- [4. Constraints and Data Types in MySQL](#4-constraints-and-data-types-in-mysql)
...
- [5. Joins and its Types in MySQL](#5-joins-and-its-types-in-mysql)
...
- [6. Subqueries in MySQL](#6-subqueries-in-mysql)
...
- [7. Stored Procedures and Triggers in MySQL](#7-stored-procedures-and-triggers-in-mysql)
